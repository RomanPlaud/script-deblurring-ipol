...
from models_yolo.common import Conv
...
class YoloDetector:
    ...
    def init_detector(self,weights_name,config_name):
        print(self.device)
        model_path = os.path.join(os.path.dirname(self._class_path),'weights/',weights_name)
        print(model_path)
        config_path = os.path.join(os.path.dirname(self._class_path),'models_yolo/',config_name)
